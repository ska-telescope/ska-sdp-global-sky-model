#!/usr/bin/env python3
"""
Generate SQLAlchemy database models from ska_sdp_datamodels dataclasses.

This script dynamically generates the models.py file by introspecting
...
def generate_db_schema_file(  # pylint: disable=too-many-statements
    ...
    """
    Generate the complete models.py file dynamically.
    ...
    # File header
    lines.append('"""')
    lines.append("SQLAlchemy ORM Models")
    lines.append("")
    lines.append("This file is AUTO-GENERATED by scripts/generate_models.py")
    ...
    lines.append("To regenerate, run: make generate-models")
    lines.append('"""')
    lines.append("")
    ...
    lines.append("from sqlalchemy.dialects.postgresql import JSON")
...
def main():
    ...
    parser = argparse.ArgumentParser(
        description="Generate SQLAlchemy database models from datamodels"
    )
    parser.add_argument(
        "--output",
        "-o",
        ...
        / "app"
        / "models.py",
        help="Output path for generated models.py file",
    )
    parser.add_argument(
        "--module",
        "-m",
