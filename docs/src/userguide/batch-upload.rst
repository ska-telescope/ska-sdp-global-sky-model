...
+---------+--------------+--------------------------------------+-----------+------------------+----------------+----------------------------+---------+----------------+---------+----------------------------+---------------------+--------+-----------+-------+-------------+-------------+
| task_id | catalogue_id | upload_id                            | status    | reason           | files_uploaded | last_update                | version | catalogue_name | staging | uploaded_at                | description         | author | reference | notes | freq_min_hz | freq_max_hz |
+---------+--------------+--------------------------------------+-----------+------------------+----------------+----------------------------+---------+----------------+---------+----------------------------+---------------------+--------+-----------+-------+-------------+-------------+
| 1       | 1            | 1aedb049-5fb2-4746-8755-3fabbf4a0afb | released  | None             | 1              | 2026-06-17 10:33:05.862381 | 0.1.0   | generic        | False   | 2026-06-17 08:33:04.297062 | Generated Catalogue | None   | None      | None  | None        | None        |
+---------+--------------+--------------------------------------+-----------+------------------+----------------+----------------------------+---------+----------------+---------+----------------------------+---------------------+--------+-----------+-------+-------------+-------------+
| 2       | 2            | b8ef4887-043c-497a-a841-e2920ff6cd51 | completed | None             | 1              | 2026-06-17 10:42:56.428036 | None    | generic        | True    | 2026-06-17 08:42:56.339189 | Generated Catalogue | None   | None      | None  | None        | None        |
+---------+--------------+--------------------------------------+-----------+------------------+----------------+----------------------------+---------+----------------+---------+----------------------------+---------------------+--------+-----------+-------+-------------+-------------+
| 3       | None         | cf04a6cc-e2f8-488b-855b-96464ae67126 | failed    | Rejected by user | 1              | 2026-06-17 10:43:03.841103 | None    | None           | None    | None                       | None                | None   | None      | None  | None        | None        |
+---------+--------------+--------------------------------------+-----------+------------------+----------------+----------------------------+---------+----------------+---------+----------------------------+---------------------+--------+-----------+-------+-------------+-------------+

Status definitions:

- ``released`` - A fully uploaded and released version.
- ``completed`` - A catalogue that was uploaded, but not committed yet.
- ``failed`` - A rejected upload. The reason for it is stored in the ``reason`` column.
