...
Generated on: 2026-02-02 10:20:50
...
class Source(Base):
    ...
    # Error in Right Ascension measurement
    ra_error = Column(Float, nullable=True)
    # Error in Declination measurement
    dec_error = Column(Float, nullable=True)
