"""
Tests for the generate_models.py script.

This module tests the model generation functionality to ensure
...
try:
    ...
    pytest.skip("generate_models.py not available", allow_module_level=True)
...
class TestGenerateDBSchemaFile:
    ...
    def test_generated_schema_has_auto_generated_warning(self):
        ...
        with tempfile.TemporaryDirectory() as tmpdir:
            ...
            assert "make generate-models" in content
