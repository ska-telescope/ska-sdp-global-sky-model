...
class TestLocalSkyModel:
    ...
    def test_save_and_load(self):
        ...
        with tempfile.TemporaryDirectory() as temp_dir_name:
            ...
            # Check that the metadata YAML file was written correctly if MetaData is available
            # If MetaData library is not installed, yaml file won't be created
            if os.path.exists(yaml_path):
                ...
                # YAML file not created - MetaData library not available
                pytest.skip("ska_sdp_dataproduct_metadata not available, skipping YAML check")
